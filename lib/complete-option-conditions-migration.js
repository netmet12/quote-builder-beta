          ...
          section.option_conditions.forEach((condition, conditionIndex) => {
            if (condition.params && condition.show) {
              ...
              condition.params.forEach(param => {
                ...
                // Debug specific important conditions
                if (sectionId === '16' || (param.allow_null === 1) || (param.condition && param.condition !== 'IN')) {
                  console.log(`   📌 Important condition - Section ${sectionId}, Group ${conditionIndex}:`, {
                    required_section: param.section,
                    required_options: param.options,
                    condition_type: param.condition || 'IN',
                    allow_null: param.allow_null === 1,
                    show_options: condition.show
                  })
                }
